...
import provider from '/root/jdbc-integration/jdbc-spring/src/main/java/io/kaumei/jdbc/examples/spring/jpa/JpaConnectionProvider.java?raw';
import config from '/root/jdbc-integration/jdbc-spring/src/main/java/io/kaumei/jdbc/examples/spring/jpa/SpringJpaConfig.java?raw';
